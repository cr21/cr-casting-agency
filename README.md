# Casting Agency Specifications
     ...
     assigning actors to those movies. You are an Executive Producer    
...
## Tests:
     Added One test for success behavior of each endpoint
     Added One test for error behavior of each endpoint
     Added At least two tests of RBAC for each role
